...
-- Generation Time: Apr 02, 2017 at 01:41 AM
...
--
-- Table structure for table `opsystem`
--

CREATE TABLE IF NOT EXISTS `opsystem` (
  `oscode` tinyint(4) NOT NULL,
  `osname` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `opsystem`
--

INSERT INTO `opsystem` (`oscode`, `osname`) VALUES
(1, 'Windows'),
(2, 'Linux'),
(3, 'MacOSX'),
(4, 'other');
...
INSERT INTO `people` (`pcode`, `pname`) VALUES
(1, 'John'),
(2, 'Jane'),
(3, 'George'),
(4, 'Sally');
...
INSERT INTO `systems` (`name`, `oscode`, `ownercode`) VALUES
('blue', 1, 2),
('red', 2, 2),
('green', 3, 1),
('brown', 2, 3);
