...
<a id='b4' href ='login/index.php'><img id="i1" src="../Images/login.png">&nbsp;Login</a>
<a id='b4' href ='signup.php'><img id="i1" src="../Images/signup.png">&nbsp;Sign Up</a>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td ><a id='b2' href="shopping.php?action=remove&ID=<?php echo $item["ID"]; ?>">Remove</a></td>
				</tr>
				<?php
...
<div id="product-grid">
<center><a id="b3" href="shopping.php?action=empty">Empty Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="b3" href="Payment.html"><img id="i1" src="../Images/check.png">&nbsp;Checkout</a></center>
	...
	?>
		<div class="product-item">
			<form method="post" action="shopping.php?action=add&ID=<?php echo $product_array[$key]["ID"]; ?>">
			<div class="product-image"><img height ="100" width="80" src="../Images/<?php echo $product_array[$key]["image"]; ?>"></div>
			<div><strong><?php echo $product_array[$key]["name"]; ?></strong></div>
			<div class="product-price"><?php echo "£".$product_array[$key]["price"]; ?></div>
			<div><input id="txt" type="text" name="quantity" value="1" size="5" /><br><br><input id="b2" type="submit" value="Add to cart"/></div>
			</form>
		</div>
	<?php
			}
