...
echo "</td>";
echo '<td><center>'. $row['name']."<br/><br/>Price : " . "£" .$row['price']. '</center><br/><br/><br/>&nbsp;&nbsp;<a id="b3" href="shopping.php"><img id="i1" src="../Images/cart.png">&nbsp;Go To Shop</a><br/>' . '</td>';
echo "</tr>";
echo "<tr>";
...
echo "</table></center>";
echo "<form action='reviews.php?id=".$it_id."'". "method='POST'>";
echo '<input id="b3" type="submit" value="Read Reviews">';
echo "</form>";
echo "<center><form action='insert1.php?id=".$it_id."'". "method='POST'>";
